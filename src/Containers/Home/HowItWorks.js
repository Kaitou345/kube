...
const HowItWorks = () => {
  return (
    <div className="bg-[#00000099] backdrop-blur-md">
      <div className="px-28 pt-20 pb-10">
        <div className="px-20 py-24 rounded-[30px] bg-[#2a2848] flex flex-col gap-20 items-start justify-between">
          ...
          <div className="flex justify-between w-full">
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-4 px-14 py-10 bg-[#37355e] rounded-lg">
