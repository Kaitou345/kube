  ...
  return (
    <div className="bg-[#00000099] backdrop-blur-md">
      <div className="px-28 py-20 gap-14 flex flex-col items-center">
        <div className="max-w-[1360px] w-full px-32 py-32 rounded-[30px] bg-[#060343] flex flex-col gap-10 items-center justify-between">
          ...
          <p className="text-3xl text-center font-light leading-[1.2]">
